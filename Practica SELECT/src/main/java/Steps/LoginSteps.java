...
public class LoginSteps extends BaseSteps {
    ...
    public String obtenerTextoMensaje() {
        ...
        //WebElement contenidoTexto = webDriver.findElement(By.cssSelector("p.has-text-align-center"));
    ...
    public boolean botonLogOutVisible() {
        WebElement elementoVista = webDriver.findElement(By.cssSelector("div.wp-block-group > div > div > a"));
